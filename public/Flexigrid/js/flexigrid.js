...
(function ($) {
	...
	$.addFlex = function (t, p) {
		...
		p = $.extend({ //apply default properties
			...
			rpOptions: [30, 50, 100], //allowed per-page values
			title: false,
			idProperty: 'id',
			pagestat: 'Показано від {from} до {to} елементів з {total}',
			pagetext: 'Сторінка',
			outof: 'з',
			findtext: 'Знайти',
			params: [], //allow optional parameters to be passed around
			procmsg: 'Завантаження...',
			query: '',
			qtype: '',
			nomsg: 'Результатів немає',
		...
		if (p.usepager) {
			...
			$(g.bDiv).after(g.pDiv);
			var html = ' <div class="pGroup"> <div class="pFirst pButton"><span></span></div><div class="pPrev pButton"><span></span></div> </div> <div class="btnseparator"></div> <div class="pGroup"><span class="pcontrol">' + p.pagetext + ' <input class="page_field" type="text" size="4" value="1" /> ' + p.outof + ' <span> 1 </span></span></div> <div class="btnseparator"></div> <div class="pGroup"> <div class="pNext pButton"><span></span></div><div class="pLast pButton"><span></span></div> </div> <div class="btnseparator"></div> <div class="pGroup"> <div class="pReload pButton"><span></span></div> </div> <div class="btnseparator"></div> <div class="pGroup"><span class="pPageStat"></span></div>';
			...
			if (p.useRp) {
				...
				$('.pDiv2', g.pDiv).prepend("<div class='pGroup'>Показувати <select name='rp' class='rp_dropdown'>" + opt + "</select> елементів</div> <div class='btnseparator'></div>");
